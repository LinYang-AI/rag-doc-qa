...
class EmbeddingModel:
    ...
    def embed_texts(self, texts: List[str], show_progress: bool = True) -> np.ndarray:
        ...
        if texts_to_embed:
            if self.config.use_openai:
                ...
                new_embeddings = self._embed_with_sentence_transformers(texts_to_embed, show_progress)
    ...
    def _embed_with_sentence_transformers(self, texts: List[str], show_progress: bool) -> np.ndarray:
